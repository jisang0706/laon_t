...
import com.example.laont.dto.CountDto
...
class AreaDetailActivity : AppCompatActivity(), AbsListView.OnScrollListener {
    ...
    private lateinit var _binding: ActivityAreaDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        comment_edit.setOnFocusChangeListener { v, hasFocus ->
            if (!hasFocus) {
                Log.e("WOW", "BEFORE GROUP" + group_id)
                group_id = 0
            }
        }
    ...
    fun initBoard() {
        val call : Call<AreaDto> = service.getArea(board_id)

        call.enqueue(object: Callback<AreaDto> {
            override fun onResponse(call: Call<AreaDto>, response: Response<AreaDto>) {
            ...
            override fun onFailure(call: Call<AreaDto>, t: Throwable) { }
        })
    }

    fun initComment() {
        val call : Call<CommentListDto> = service.getComment(board_id, paginate++)
    ...
    fun writeReply(group_id: Int) : Boolean {
    ...
    fun uploadComment() {
        ...
        val call : Call<CommentListDto> = service.uploadComment(board_id, google_token, group_id, comment_edit.text.toString())
    ...
    fun delete() {
        ...
        builder.setPositiveButton("확인", DialogInterface.OnClickListener { dialog, which ->
            val call = service.deleteBoard(board_id, google_token)
